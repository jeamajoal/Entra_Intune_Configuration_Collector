...
function Invoke-CollectorEntraGovernanceStage3 {
    ...
    foreach ($assignment in $assignments) {
        ...
        $edges += ConvertTo-CollectorActiveRoleAssignmentEdge -Assignment $assignment
    }
    ...
    $results += @($script:CollectorEntraGovernanceStage3Module.Invoke($edgeRunner, [object[]]@($Context, $edges)))
