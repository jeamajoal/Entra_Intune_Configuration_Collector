...
"@
    ...
    # Stage1/Stage2 import the provider into their own module sessions. Import it last
    # in the test session so the direct provider assertions have an explicit binding.
