BeforeAll {
    ...
    function Write-TestRawSnapshot {
        ...
        $json = '{"schemaVersion":"1.0","runId":"persisted-itemcount-type","stage":"stage1","section":"entra-apps","family":"applications","batchId":"0001","collectedUtc":"2026-09-08T00:00:00.0000000Z","sourceType":"Test","sourceName":"fixture","apiVersion":"n/a","isBeta":false,"requestContext":{},"itemCount":' + $ItemCountJson + ',"items":[{"id":"seed-1"}]}'
...
Describe 'Persisted plan and snapshot itemCount type integrity' {
    ...
    It 'reprocesses artifact-present succeeded state whose persisted snapshot itemCount is schema-invalid' {
        ...
        Set-Content -LiteralPath $script:artifactPath -Value '{"schemaVersion":"1.0","runId":"persisted-itemcount-type","stage":"stage1","section":"entra-apps","family":"applications","batchId":"0001","collectedUtc":"2026-09-08T00:00:00.0000000Z","sourceType":"Test","sourceName":"fixture","apiVersion":"n/a","isBeta":false,"requestContext":{},"items":[{"id":"seed-1"}]}' -Encoding UTF8
    ...
    It 'keeps valid numeric and legitimate zero-item persisted snapshot counts skippable' {
        ...
        foreach ($case in $validCases) {
            ...
            Set-Content -LiteralPath $script:artifactPath -Value ('{"schemaVersion":"1.0","runId":"persisted-itemcount-type","stage":"stage1","section":"entra-apps","family":"applications","batchId":"0001","collectedUtc":"2026-09-08T00:00:00.0000000Z","sourceType":"Test","sourceName":"fixture","apiVersion":"n/a","isBeta":false,"requestContext":{},"itemCount":' + $case.Json + ',"items":' + $itemsJson + '}') -Encoding UTF8
